...
---
## 🛡️ 5. NO-BROWSER POLICY

- **Quy tắc**: TUYỆT ĐỐI không sử dụng `browser_subagent` hoặc `open_browser_url` để kiểm tra kết quả (trừ khi có yêu cầu).
- **Lý do**: Môi trường không hỗ trợ GUI hoàn chỉnh, gây lỗi và tốn tài nguyên. Luôn dựa trên phân tích mã nguồn và terminal.
